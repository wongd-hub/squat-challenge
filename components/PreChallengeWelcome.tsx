      ...
      <Card className="mb-8 glass-strong">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <div className="space-y-3">
            <p>
              <strong className="text-foreground">🏋️ The Challenge:</strong> This {CHALLENGE_CONFIG.TOTAL_DAYS}-day challenge mimics the progressive targets of the renowned Pushup Challenge, adapted for building strength and endurance.
            </p>
            <p>
              <strong className="text-foreground">🎯 How It Works:</strong> Use our intuitive dial to count your daily reps (drag clockwise to add, counter-clockwise to subtract), then bank your progress to track your journey.
            </p>
            <p>
            ...
            <p>
              <strong className="text-foreground">📅 Challenge Structure:</strong> Progressive daily targets from 50-150 reps with strategic rest days for recovery. Some days are rest days (0 reps) to help you recover and stay strong.
            </p>
          </div>
      ...
      <Card className="glass-strong bg-gradient-to-br from-green-50/50 to-blue-50/50 dark:from-green-950/20 dark:to-blue-950/20 border-green-200/30 dark:border-green-800/30">
        <CardContent className="p-6 md:p-8 text-center">
          ...
          <p className="text-sm md:text-base text-muted-foreground mb-4">
            Use this time to prepare yourself mentally and physically. When the challenge begins, you'll have access to the dial, progress tracking, leaderboards, and all the tools you need to succeed.
          </p>
