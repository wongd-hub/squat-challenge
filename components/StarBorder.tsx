      ...
      <div
        ...
        style={{
          background: color === "cyan" 
            ? `radial-gradient(circle, transparent 10%, transparent 30%), radial-gradient(ellipse, cyan 0%, magenta 50%, transparent 70%)`
            : `radial-gradient(circle, ${color}, transparent 10%)`,
